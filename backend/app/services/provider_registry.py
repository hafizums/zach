...
from app.providers.openai_provider import OpenAILLMProvider, OpenAITTSProvider, OpenAITranscriptionProvider
...
registry.register("openai", "transcription", OpenAITranscriptionProvider())
